...
return [
	...
	'modules'=>array_merge([
        HCrud::getMenuItems(Y::controller(), 'articles', 'crud/index', true, D::yd()->isActive('articles')),
        HCrud::getMenuItems(Y::controller(), 'services', 'crud/index', true, D::yd()->isActive('services')),
       [
