...
<div class="form js-form-box" style="display:none">
    ...
    $tabs = array(
        ...
        // 'Логотипы'=>array('content'=>$this->renderPartial('settings_logo', compact('model', 'form'), true), 'id'=>'tab-logo'),
        // 'ReCaptcha3'=>array('content'=>$this->renderPartial('settings_recaptcha3', compact('model', 'form'), true), 'id'=>'tab-recaptcha3'),
        ...
        'Соц. сети'  =>array('content'=>$this->renderPartial('settings_social'    , compact('model', 'form'), true), 'id'=>'tab-social'),
        'Мессенджеры'  =>array('content'=>$this->renderPartial('settings_messenger'    , compact('model', 'form'), true), 'id'=>'tab-messenger'),
        'Дополнительные контакты'  =>array('content'=>$this->renderPartial('settings_additional_contacts'    , compact('model', 'form'), true), 'id'=>'tab-contacts'),
    );
