...
<div class="row">
    <?php echo $form->checkBox($model, 'shop_enable_filter'); ?>
    <?php echo $form->labelEx($model, 'shop_enable_filter', array('class'=>'inline')); ?>
	<?php echo $form->error($model, 'shop_enable_filter'); ?>
</div>
