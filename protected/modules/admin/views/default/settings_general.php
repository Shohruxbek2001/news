...
<? $this->widget('\common\widgets\form\TextField', A::m(compact('form', 'model'), ['attribute'=>'ymap_apikey'])); ?>

<div class="row">
    <?php echo $form->label($model,'dev_year'); ?>
    <div class="col-md-3">
        <?php echo $form->numberField($model,'dev_year', ['class'=>'form-control inline', 'min'=>0, 'step'=>1, 'style'=>'width:80%'])?> г.
        &nbsp;<strong style="position:relative;left:13px">&ndash;</strong>
        <?php echo $form->error($model,'dev_year'); ?>
    </div>
    <div class="col-md-3">
        <?php echo $form->numberField($model,'dev_year_to', ['class'=>'form-control inline', 'min'=>0, 'step'=>1, 'style'=>'width:80%'])?> г.
