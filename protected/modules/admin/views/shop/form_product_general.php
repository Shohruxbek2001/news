...
?>
<?= HHtml::onReady('js-form-tabs', ['message'=>'Подождите, идет загрузка страницы...']); ?>
<div class="form js-form-tabs" style="display: none">
    ...
    if(Yii::app()->params['attributes'])
        $tabs['Атрибуты'] = array('content'=>$this->renderPartial('_form_product_attributes', compact('model', 'form', 'fixAttributes', 'eavAttributes', 'productAttrs'), true), 'id'=>'tab-attrs');
