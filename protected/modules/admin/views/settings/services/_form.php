...
<? 
	...
	$this->widget('zii.widgets.jui.CJuiTabs', [
		'tabs'=>[
			'Основые'=>['content'=>$this->renderPartial('/settings/services/_main', compact('model', 'form'), true), 'id'=>'tab-main'],
			'SEO'=>['content'=>$this->renderPartial('/settings/services/_seo', compact('model', 'form'), true), 'id'=>'tab-seo']
		],
		'options'=>[]
	]);
	?>
