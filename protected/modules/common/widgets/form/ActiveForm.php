...
class ActiveForm extends \common\components\base\Widget
{
	 ...
	 * @param bool $skipTypeCallable пропустить обработку callable для типа.
     * Актуально, если внутри callable фукнции типа нужно вывести поле.     
     */
    public function renderAttribute($form, $attribute, $type=null, $skipTypeCallable=false)
    {
        if($type === null) {
        ...
        if(!$skipTypeCallable && is_callable($type)) {
