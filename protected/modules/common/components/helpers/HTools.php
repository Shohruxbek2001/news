...
class HTools
{
     ...
     * Форматирование даты
     *
     * Если дата передана пустая или некорректная, то будет возвращена текущая дата.
     *
     * @param string $format формат даты в синтаксисе DateTimeInterface::format().
     * По умолчанию Y-m-d.
     * @param int|string|\DateTime|null $date дата
     * @return string дата в переданном формате
     */
    public static function formatDate($format='Y-m-d', $date=null)
    {
