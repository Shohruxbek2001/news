...
class Slider extends \common\components\base\ActiveRecord
{
	...
	{
		// Fix: если полностью удалить опции слайда, то они не сохраняются
		if(!empty($_POST['extend_modules_slider_models_Slider'])) {
			if(empty($_POST['extend_modules_slider_models_Slider']['slide_properties'])) {
