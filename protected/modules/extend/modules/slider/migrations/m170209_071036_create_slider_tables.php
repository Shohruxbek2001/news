	...
	FOREIGN KEY `fk_slider_id` (`slider_id`) REFERENCES `slider_sliders` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
		...
		$this->insert('slider_sliders', [
			...
			'options'=>json_encode([
			    ...
			    ['active'=>1, 'code'=>'config', 'title'=>'Конфигурация', 'value'=>'default'],
			    ['active'=>1, 'code'=>'width', 'title'=>'Ширина', 'value'=>-1, 'unit'=>'px'],
			    ['active'=>1, 'code'=>'height', 'title'=>'Высота', 'value'=>-1, 'unit'=>'px'],
