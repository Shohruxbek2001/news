	...
	'crud'=>[		
		'index'=>[
			...
			'gridView'=>[ 
                ...
                'emptyText'=>'Слайдеров не найдено',
                'summaryText'=>'', // 'Слайдеры {start} &mdash; {end} из {count}',
				'columns'=>!$extraAccess ? [] : [
					'id'=>[
						'name'=>'id',
						'header'=>'#',
			        ...
			        'slide_properties'=>[
			            ...
			            'params'=>[
			                'header'=>[
			                    ...
			                    'type'=>[
			                         'title'=>$t('slider.slideProperties.type.title'),
			                ...
			                'types'=>[
			                    ...
			                    'type'=>[
									...
									'params'=>['htmlOptions'=>['style'=>'width:100%;font-size:0.85em;height:26px']]
								],
