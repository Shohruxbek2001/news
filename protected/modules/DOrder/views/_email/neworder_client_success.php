...
/** @var int $markup размер наценки (например, стоимость доставки) */ 
$markup = 0;
$markupLabel = 'Доставка';
?>
...
<html>
	...
	<body style="font-family: Arial, Helvetica, sans-serif; font-size: 12px; color: #000000;">
		<div style="width: 680px;">
			...
			<?endif;?>
			<?foreach($customer as $key=>$personal): if(($personal['value'] === '') || in_array($key, ['paymentType', 'privacy_policy'])) continue; ?>
			...
			<table style="border-collapse: collapse; width: 100%; border-top: 1px solid #DDDDDD; border-left: 1px solid #DDDDDD; margin-bottom: 20px;">
				...
				<? if(($discount > 0) || ($markup > 0)) { ?>
					<tr>
						<td style="font-size: 12px;	border-right: 1px solid #DDDDDD; border-bottom: 1px solid #DDDDDD; text-align: right; padding: 7px;" colspan="4"><b>Сумма заказа:</b></td>
					...
					<? if($markup > 0) { ?>
					<tr>
						<td style="font-size: 12px;	border-right: 1px solid #DDDDDD; border-bottom: 1px solid #DDDDDD; text-align: right; padding: 7px;" colspan="4"><b><?=$markupLabel?>:</b></td>
						<td style="font-size: 12px;	border-right: 1px solid #DDDDDD; border-bottom: 1px solid #DDDDDD; text-align: right; padding: 7px;"><?=$markup?> руб.</td>
					</tr>
					<? } ?>
					<? if($discount > 0) { ?>
					<tr>
						<td style="font-size: 12px;	border-right: 1px solid #DDDDDD; border-bottom: 1px solid #DDDDDD; text-align: right; padding: 7px;" colspan="4"><b><?=$discountLabel?>:</b></td>
						<td style="font-size: 12px;	border-right: 1px solid #DDDDDD; border-bottom: 1px solid #DDDDDD; text-align: right; padding: 7px;"><?=$discount?> руб.</td>
					</tr>
					<? } ?>
					<tr>
						...
						<td style="font-size: 12px;	border-right: 1px solid #DDDDDD; border-bottom: 1px solid #DDDDDD; text-align: right; padding: 7px;"><?= ($total + $markup - $discount); ?> руб.</td>
					</tr>
					<? } else { ?>
					<tr>
						<td style="font-size: 12px;	border-right: 1px solid #DDDDDD; border-bottom: 1px solid #DDDDDD; text-align: right; padding: 7px;" colspan="4"><b>Итого:</b></td>
