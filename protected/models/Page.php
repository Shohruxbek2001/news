...
class Page extends \common\components\base\ActiveRecord
{
	...
	public function attributeLabels()
	{
		return $this->getAttributeLabels(array(
            ...
            'show_page_title' => 'Выводить заголовок страницы в темплейте'
		));
	}
    ...
    protected function beforeSave()
    {
        ...
        $this->intro = HtmlHelper::getIntro($this->text);
        return true;
    }
    ...
    public function isShowPageTitle()
    {
        return (bool)$this->show_page_title;
    }
