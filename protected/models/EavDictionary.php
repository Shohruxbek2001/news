 ...
 */
class EavDictionary extends CActiveRecord
{
    /**
    ...
    public function rules()
    {
        ...
        return array(
            ...
            array('id_attrs', 'numerical', 'integerOnly' => true),
            array('value, property', 'length', 'max' => 255),
            // The following rule is used by search().
            // @todo Please remove those attributes that should not be searched.
            array('id, id_attrs, value', 'safe', 'on' => 'search'),
        );
    }
