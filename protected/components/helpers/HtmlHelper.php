...
class HtmlHelper extends CComponent
{
	...
	public static function getIntro($text, $length=300, $detailLink='...')
	{
        ...
        $text = preg_replace('/{\w+}/', '', mb_substr($text, 0, $length));
	...
	public static function replaceEndLineToParagraph($text)
    {
    ...
    /**
     * Разбивание адресов на строки
     * @param $text
     * @return string
     */
    public static function splitAddress($text)
    {
        $ret = strip_tags($text);
