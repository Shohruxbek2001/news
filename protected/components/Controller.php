...
class Controller extends DController
{
    ...
    public function actionGetMainCounterScripts()
    {
        echo D::cms(self::COUNTER_SETTING_NAME);
        die;
    }
    ...
    {
        Y::js('main_counter_script_load', 'window.mainCounterScriptLoaded=false;$(document).on("scroll mousemove", function(){
